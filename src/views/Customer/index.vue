                        ...
                        <a-form-model :model="list"  layout="horizontal">
                            ...
                            <div class="secondPart">
                                ...
                                <a-form-model-item class="custom-form-item address" label="公司地址">
                                    <div style="width: 10%">
                                        <a-input v-model="list.companyPostcode" placeholder="郵遞區號" />
                                    </div>
                                    <div>
                                        <a-input v-model="list.companyAddress" placeholder="請輸入" />
                                    </div>
                                </a-form-model-item>
                            </div>
                        </a-form-model>
...
<script>
    ...
    export default {
        ...
        methods:{
            getList() {
                axios.get('/erp/client/clients?searchKeyword=')
                    .then((res) => {
            ...
            handleOk() {
                if (this.changeTitle === '新增客戶') {
                    ...
                    axios.put('/erp/client/updateClient', {
                        id:this.track,
            ...
            editHandler(record){
                ...
                axios.get('/erp/client/' + record.id)
                    .then((res) => {
                        if (res.data !== "") {
                            this.list = res.data
                            this.visible = true
